{
    ...
    "pooladmin": "role:loadbalancer_pooladmin and rule:owner",
    ...
    "context_is_viewer": "rule:context_is_editor or rule:viewer or rule:pooladmin",
    ...
    "os_load-balancer_api:loadbalancer:post": "rule:context_is_editor",
    ...
    "os_load-balancer_api:member:post": "rule:context_is_editor or rule:pooladmin",
    "os_load-balancer_api:member:get_one": "rule:context_is_viewer",
    "os_load-balancer_api:member:put": "rule:context_is_editor or rule:pooladmin",
    "os_load-balancer_api:member:delete": "rule:context_is_editor or rule:pooladmin",

    "os_load-balancer_api:pool:get_all": "rule:context_is_viewer",
    "os_load-balancer_api:pool:get_all-global": "rule:context_is_editor or rule:pooladmin",
    "os_load-balancer_api:pool:post": "rule:context_is_editor or rule:pooladmin",
    "os_load-balancer_api:pool:get_one": "rule:context_is_viewer",
    "os_load-balancer_api:pool:put": "rule:context_is_editor or rule:pooladmin",
    "os_load-balancer_api:pool:delete": "rule:context_is_editor or rule:pooladmin",

    "os_load-balancer_api:provider:get_all": "rule:context_is_viewer",

    "os_load-balancer_api:quota:get_all": "rule:context_is_editor or role:resource_service",
    "os_load-balancer_api:quota:get_all-global": "rule:context_is_editor or role:resource_service",
    "os_load-balancer_api:quota:get_one": "rule:context_is_editor or role:resource_service",
